...
angular
  ...
  .controller("HomeCtrl", function($scope, DataService, $filter, $http, $sce) {
    ...
    $scope.tipo_colors = function(d){
      ...
      c["AGUA Y SANEAMIENTO"] = "#56B197";
      c["OBRAS VIALES"] = "#D85826";
      c["ALUMBRADO PUBLICO"] = "#AEC45F";
      c["OBRAS HÍDRICAS"] = "#7775AE";
      c["CONECTIVIDAD ELÉCTRICA"] = "#AF4990";
      c["GAS"] = "#D1372E";
      c["VIVIENDAS"] = "#e8af53";
      c["OTRAS"] = "#8F663E";
    ...
    $scope.selectTypes.push({
      ...
      $scope.selectTypes.push({
      label: "OBRAS HÍDRICAS",
      slug: "obras-hidricas"
    })
      $scope.selectTypes.push({
      label: "CONECTIVIDAD ELÉCTRICA",
      slug: "conectividad-electrica"
    })
    $scope.selectTypes.push({
      label: "GAS",
      slug: "gas"
    ...
    $scope.labels["arquitectura"] =
      "Obras";
    $scope.labels["agua-y-saneamiento"] =
      "Obras";

    $scope.labels["obras-viales"] =
      "Obras";
    $scope.labels["alumbrado-publico"] =
      "Obras";
    $scope.labels["obras-hidricas"] =
      "Obras";
    $scope.labels["conectividad-electrica"] =
      "Obras";
    $scope.labels["gas"] =
    "Obras";
    $scope.labels["viviendas"] =
    "Obras";
    $scope.labels["otras"] =
      "Obras";
    ...
    DataService.getAll().then(function(data) {
      ...
      $scope.availableGroups = [
        { id: "mapa", name: "Mapa" },
        { id: "comunas", name: $scope.useComunas ? "Comunas" : "Departamentos" },
    ...
    function renderEtapasGroup(clear) {
      ...
      var etapas_string = {
        ...
        "en-licitacion": "En proceso licitatorio",
    ...
    function renderLogoTipo(type, svgNode, logoContainer) {
      ...
      logoContainer.node().innerHTML = "<div class='sincircle-bg'></div>";
