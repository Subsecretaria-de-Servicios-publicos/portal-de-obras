...
var cleanData = function(oldReg, index, Slug) {
  ...
  reg.porcentaje_avance =
    ...
    reg.porcentaje_avance_enejecucion =
    reg.etapa === "En ejecución" ? 1 : reg.porcentaje_avance_enejecucion;

    reg.porcentaje_avance_enproyecto =
    reg.etapa === "En proyecto" ? 2 : reg.porcentaje_avance_enproyecto;

    reg.porcentaje_avance_enlicitacion =
    reg.etapa === "En licitación" ? 3 : reg.porcentaje_avance_enlicitacion;
